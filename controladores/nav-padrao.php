        ...
        <div class="row">
            <div class="col-xl-4">
                <a class="navbar-brand d-none d-lg-block" href="index.php">
                    <img src="./css/imagens/logo.fupreb.png" alt="Fundo de Previdência" width="180" height="150">
                </a>
            </div>
            <div class="col-xl-2">
                <strong>FUBREP</strong>
                <ul class="mt-3 ulTexto">
                    <li><a class="no-underline2" href="sobre.php"> - Sobre FUBREP</a></li>
...
<div class="mt-3 pb-3 pt-3" id="fale-conosco" style="display: none;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-4">
                <a class="navbar-brand d-none d-lg-block" href="index.php">
                    <img src="./css/imagens/logo.fupreb.png" alt="Câmara Municipal de #" width="180" height="150">
                </a>
            </div>
            <div class="col-xl-4">
